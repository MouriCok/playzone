...
<div class="container" id="mainContainer">
    ...
    <div id="settingsContent">
            ...
            <ul>
                <?php if (!$isGoogleUser): ?>
                    <li class="heading">
                        ...
                        <span class="notice">Link your Google account for easier login.</span>
                        <button type="button" onclick="connectGoogle()" class="google-btn">
                            <img src="Icons/google-color.svg" alt="Google Logo" class="google-logo" width="20" height="20">Connect Google
                        </button>
                    </li>
                <?php endif; ?>
                <li class="heading">
                    <label>Connect to WhatsApp:</label>
                    <span class="notice">Link your WhatsApp for getting Notifications.</span>
                    <button onclick="connectWhatsApp()">Connect WhatsApp</button>
                </li>
                <li class="heading">
                    <label>Connect to Telegram:</label>
                    <span class="notice">Link your Telegram for getting Notifications.</span>
        ...
        <section id="notifications" class="section box">
            ...
            <form id="notification-settings">
                ...
                <div>
                    <label><input type="checkbox"> Enable WhatsApp Notifications<span class="notice"> (Requires WhatsApp linked)</span></label>
                </div>
                <div>
                    <label><input type="checkbox"> Enable Telegram Notifications<span class="notice"> (Requires Telegram linked)</span></label>
                </div>
            </form>
        </section>
    ...
    <div id="bookingTable" style="display: none;">
        ...
        <section id="bookingHistory" class="section table-box">
            <button onclick="hideBookingHistory()" class="back-button">Back</button>
            <table class="table">
                <thead>
                    <tr>
                        <th>Booking ID</th>
...
<script>
    ...
    function fetchPage(page) {
        fetch("fetch_booking_history.php?page=" + page)
            .then(response => response.text())
            .then(data => {
                document.getElementById("bookingList").innerHTML = data;
            })
